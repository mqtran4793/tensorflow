...
#echo ${REGISTRY_PASSWORD} | docker login --username DOCKER_USERNAME=${REGISTRY_USERNAME} --password-stdin DOCKER_PASSWORD=${REGISTRY}
docker login -u DOCKER_USERNAME=${REGISTRY_USERNAME} --password-stdin DOCKER_PASSWORD=${REGISTRY_PASSWORD}
